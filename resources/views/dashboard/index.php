...
$ap = htmlspecialchars((string) ($areaPrefix ?? '/gestor'));
...
<div class="cae-dash-hero">
    ...
    <div class="row align-items-center g-3 position-relative">
        <div class="col-lg-8">
            <div class="cae-dash-hero-kicker">Tu cartera CAE</div>
            <h2 class="cae-dash-hero-title mb-2"><?= (int) ($kpiTechnicians ?? 0) ?> técnicos asociados</h2>
            <p class="cae-dash-hero-meta mb-0">
                <span><i class="bi bi-buildings me-1"></i><?= (int) ($kpiCommunities ?? 0) ?> comunidades</span>
    ...
    <div class="col-lg-6">
        <div class="cae-dash-chart-card">
            <div class="cae-dash-chart-head">
                ...
                <span class="small text-muted">Tu cartera</span>
            </div>
